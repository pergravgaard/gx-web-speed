...
DProgressPie.prototype.render = function() {
	...
	var bw = this.config.fill ? 0 : dPies.item(0, true).parseCSS('borderLeftWidth'); // Firefox do not support borderWidth, but left, top, right and bottom have the same value
	dPies.css({
		borderWidth: bw,
